...
{
    /// <summary>
    /// thanks to https://github.com/EverestAPI/CelesteCollabUtils2 
    /// </summary>
    public static class HookHelper
    {
        ...
        {
            Logger.Log(LogLevel.Info, "CollabUtils2/HookHelper", "starting...");
            ...
            foreach (TypeDefinition nest in type.NestedTypes)
            {
                if (nest.Name.StartsWith("<" + methodName + ">d__"))
                {
                    ...
                    Logger.Log(LogLevel.Info, "CollabUtils2/HookHelper", $"Building IL hook for method {method.FullName} in order to mod {typeName}.{methodName}()");
